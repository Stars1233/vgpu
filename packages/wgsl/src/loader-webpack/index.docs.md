...
|---|---|---|---|---|
| source | string | ✔ | — | Raw WGSL file contents supplied by webpack. Ordinary leaves without top-level imports or direct `export fn` declarations are emitted directly, optionally minified. Exported leaves and import graphs are resolved from `this.resourcePath`. |
